...
const gameDraw = (() => {
    ...
    return ratio => {
        ...
        { // Draw leaderboard
            ...
            text.lbtitle.draw(
                'Board of Leaders:', Math.round(x + len / 2) + 0.5,
                Math.round(y - 6) + 0.5,
...
const gameDrawDead = (() => {
    ...
    return () => {
        ...
        text.taunt.draw(
            'you are now ded, congrats', x, y - 80, 11, color.guiwhite, 'center'
        );
        text.level.draw(
        ...
        text.score.draw(
            'Number from actions: ' + formatLargeNumber(Math.round(global.finalScore.get())),
